...
#include<sstream>
#include<iostream>
Int_Node::Int_Node(int key) : key(key), left(nullptr), right(nullptr), parent(nullptr), color(Red) {}
...
void RBTree::print1(const Int_Node*ptr){
	...
	if (ptr->parent == nil) cout << ' ';
	else cout << ptr->parent->key;
	 cout <<" color: ";
	 if (ptr->color) cout << "black\n";
	 else cout << "red\n";
	if(ptr->right!=nil){
		print1(ptr->right);
	}
