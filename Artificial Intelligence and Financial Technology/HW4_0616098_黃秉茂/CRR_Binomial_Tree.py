...
plt.plot(Q2_index[1:], Q2_1[:, -1], 'r', Q2_index[1:], Q2_2[:, -1], 'g')
...
for i in range(3):
	term = 100 * 10 ** i
	Q3_term.append(term)
	Q3_bls_callprice.append(bls_callprice(50, 40, 0.08, 2, 0.2))
	print('black-scholes model:', Q3_bls_callprice[i])
...
plt.title('Q4. Abosolute error')
plt.plot(Q3_term, Q3_MC_100_error, 'r', Q3_term, Q3_MC_1000_error, 'g', Q3_term, Q3_MC_100_error, 'b')
...
# 會和black-scholes的結果差不多
print(BTcall(50, 40, 2, 0.08, 0.2, 1000))
print(BTcall_formula(50, 40, 2, 0.08, 0.2, 1000))
print(BTcall_formula_fast(50, 40, 2, 0.08, 0.2, 1000))

sa = MCsim(50, 2, 0.08, 0.2, 10000)
plt.plot(sa)
plt.show()

print(MCsim_EU_opt_call(50, 40, 2, 0.08, 0.2, 1000, 1000))
print(MCsim_multiple_EU_opt_call(50, 40, 2, 0.08, 0.2, 1000, 1000))
print(MCsim_multiple_Asia_opt_call(50, 40, 2, 0.08, 0.2, 1000, 1000))